...
=item The downloads link is on the left of the home page, find the species
...
=item you can use any of the annotation tracks as long as they have the five fields you
are asked to select below:

=item the following illustrates using two tracks "UCSC Known" and "RefSeq". 

=item If there are many annotation tracks, such as for mouse where there are more than ten,
